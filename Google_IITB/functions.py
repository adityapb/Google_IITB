...
class Search:
	...
	def __init__(self):
		f = open("/home/aditya/Desktop/Google_IITB/Google_IITB/keyweights.p", "rb")
		self.keyweights = pickle.load(f)
		f.close()
		
		f = open("/home/aditya/Desktop/Google_IITB/Google_IITB/data.p", "rb")
		self.hash_table = pickle.load(f)
		f.close()
		
		with open("/home/aditya/Desktop/Google_IITB/Google_IITB/pageranks.p","rb") as fp:
			self.ranks = pickle.load(fp)
		
		self.d = DictWithPWL("en_US", "/home/aditya/Desktop/Google_IITB/Google_IITB/allkeys.txt")
